...
public class PageMaster
{
    ...
    public static List<PageMaster> GetAllPageMaster(SqlConnection conSR)
    {
    ...
    public static int InsertPageMaster(SqlConnection conSR, PageMaster cat)
    {
        int result = 0;
    ...
    public static int UpdatePageMaster(SqlConnection conSR, PageMaster cat)
    {
        int result = 0;
    ...
    public static int DeletePageMaster(SqlConnection conSR, PageMaster cat)
    {
        int result = 0;
