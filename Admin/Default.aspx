...
<head runat="server">
    <title>Vinayaka Travels | Admin</title>
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center mt-2">
                                        <a href="javascript:void(0);" class="d-inline-block auth-logo">
                                            <img src="assets/images/vinayaka-logo.png" alt="" height="70" />
                                        </a>
                                    </div>
                                    <div class="text-center mt-2">
                                        <h5 class="text-primary">Welcome Back ! </h5>
                                        <p class="text-muted">Sign in to continue to <b>Vinayaka Travels</b> </p>
