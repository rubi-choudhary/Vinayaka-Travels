    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Page.IsValid)
            {
                ...
                CreateUser logins = CreateUser.Login(conSR, inputs);
                if (logins.UserGuid != null)
                {
                    ...
                    else if (logins.Status == "Active")
                    {
                        ...
                        HttpCookie cookie = new HttpCookie("hi_aid");
                        cookie.Value = logins.UserGuid;

                        //this cookie is to validate password key
                        HttpCookie cookie_pass_key = new HttpCookie("hi_apkv");
                        ...
                        CreateUser.UpdateLastLoginTime(conSR, logins.UserGuid);
